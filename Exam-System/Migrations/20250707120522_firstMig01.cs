...
{
    /// <inheritdoc />
    public partial class firstMig01 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ChoiseText = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateOnly(2025, 7, 7), "Basic C# exam for beginners.", "C# Fundamentals", null },
                    { 2, new DateOnly(2025, 7, 7), "Intermediate ASP.NET Core exam.", "ASP.NET Core", null }
                });
